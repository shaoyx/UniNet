...
int binary = 0, cbow = 0, debug_mode = 2, window = 10, min_count = 5, num_threads = 24, min_reduce = 1;
int *vocab_hash;
...
void TrainModel() {
  ...
  printf("Starting training using file");
